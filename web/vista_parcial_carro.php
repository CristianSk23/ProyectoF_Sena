            ...
            <td class="column-4">
                <div class="wrap-num-product flex-w m-l-auto m-r-0">
                    ...
                    <input class="mtext-104 cl3 txt-center num-product" type="number"
                        ...
                        max="<?php echo $stock['stock_cantidad']; ?> " id="cantidad"
                        data-url="<?php echo getUrl('CarroDeCompras', 'CarroDeCompras', 'actualizarCantidadCarro', false, 'ajax'); ?>"
                        data-talla="<?php echo $talla; ?>" data-color="<?php echo $color; ?>" readonly>
                ...
                <div>
                    ...
                    <a>
                        <button class="btn btn-danger eliminar-producto"
                            ...
                            data-id-usuario="<?php echo $_SESSION['usu_id']; ?>" data-color="<?php echo $color; ?>"
                            data-talla="<?php echo $talla; ?>">
                            <i class="fa-sharp fa-solid fa-trash-can fa-lg" style="color: #f0eded;"></i>
                        </button>
                    </a>
                </div>
            </td>
