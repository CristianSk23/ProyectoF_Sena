<<<<<<<< HEAD:web/shoping-cart.php <!DOCTYPE html>
	<html lang="en">
	...
	========
	>>>>>>>> origin/InterfazConfiguracionU/Linda:view/partials/shoping-cart.php

	<body class="animsition">

		<<<<<<<< HEAD:web/shoping-cart.php========<div class="right-top-bar flex-w h-full">
			...
			<<<<<<<< HEAD:web/shoping-cart.php <!-- Footer -->
